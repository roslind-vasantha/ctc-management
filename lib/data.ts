...
// Mix of pending (30%) and submitted (70%) onboarding states
export const retailers: Retailer[] = [
  // D001 - Riyadh (R001-R003: 2 submitted, 1 pending)
  ...
  { id: 'R003', distributorId: 'D001', name: 'Fast Finance Riyadh South', email: 'south@ff-riyadh.sa', phone: '+966-11-111-3333', city: 'Riyadh', kycStatus: 'pending', monthVolume: 42, monthGmv: 168000, createdAt: daysAgo(280), active: true, onboardingState: 'pending', ...generateRetailerOnboardingData('R003', 'pending') },

  // D002 - Jeddah (R004-R006: 2 submitted, 1 pending)
  ...
  { id: 'R006', distributorId: 'D002', name: 'Red Sea Finance', email: 'redsea@finance.sa', phone: '+966-12-222-3333', city: 'Jeddah', kycStatus: 'pending', monthVolume: 38, monthGmv: 152000, createdAt: daysAgo(240), active: true, onboardingState: 'pending', ...generateRetailerOnboardingData('R006', 'pending') },

  // D003 - Dammam (R007-R009: 2 submitted, 1 pending)
  ...
  { id: 'R009', distributorId: 'D003', name: 'Gulf Finance Express', email: 'gulf@fexpress.sa', phone: '+966-13-333-3333', city: 'Dammam', kycStatus: 'pending', monthVolume: 28, monthGmv: 112000, createdAt: daysAgo(210), active: true, onboardingState: 'pending', ...generateRetailerOnboardingData('R009', 'pending') },

  // D004 - Mecca (R010-R012: 2 submitted, 1 pending)
  ...
  { id: 'R012', distributorId: 'D004', name: 'Quick Service Mecca', email: 'quick@mecca.sa', phone: '+966-12-444-3333', city: 'Mecca', kycStatus: 'pending', monthVolume: 23, monthGmv: 92000, createdAt: daysAgo(180), active: true, onboardingState: 'pending', ...generateRetailerOnboardingData('R012', 'pending') },

  // D005 - Medina (R013-R015: 2 submitted, 1 pending)
  ...
  { id: 'R014', distributorId: 'D005', name: 'Prophet City Finance', email: 'pcf@medina.sa', phone: '+966-14-555-2222', city: 'Medina', kycStatus: 'verified', monthVolume: 26, monthGmv: 104000, createdAt: daysAgo(160), active: true, onboardingState: 'submitted', ...generateRetailerOnboardingData('R014', 'submitted') },
  { id: 'R015', distributorId: 'D005', name: 'Medina Money Point', email: 'mmp@medina.sa', phone: '+966-14-555-3333', city: 'Medina', kycStatus: 'pending', monthVolume: 22, monthGmv: 88000, createdAt: daysAgo(150), active: true, onboardingState: 'pending', ...generateRetailerOnboardingData('R015', 'pending') },

  // D006 - Khobar (R016-R018: 2 submitted, 1 pending)
  ...
  { id: 'R017', distributorId: 'D006', name: 'Corniche Finance', email: 'corniche@finance.sa', phone: '+966-13-666-2222', city: 'Khobar', kycStatus: 'verified', monthVolume: 22, monthGmv: 88000, createdAt: daysAgo(130), active: true, onboardingState: 'submitted', ...generateRetailerOnboardingData('R017', 'submitted') },
  { id: 'R018', distributorId: 'D006', name: 'Khobar Quick Money', email: 'quick@khobar.sa', phone: '+966-13-666-3333', city: 'Khobar', kycStatus: 'pending', monthVolume: 18, monthGmv: 72000, createdAt: daysAgo(120), active: true, onboardingState: 'pending', ...generateRetailerOnboardingData('R018', 'pending') },

  // D007 - Tabuk (R019-R021: 1 submitted, 2 pending)
  ...
  { id: 'R021', distributorId: 'D007', name: 'Tabuk Money Services', email: 'tms@tabuk.sa', phone: '+966-14-777-3333', city: 'Tabuk', kycStatus: 'pending', monthVolume: 0, monthGmv: 0, createdAt: daysAgo(30), active: true, onboardingState: 'pending', ...generateRetailerOnboardingData('R021', 'pending') },

  // D008 - Abha (R022-R024: 1 submitted, 2 pending)
  { id: 'R022', distributorId: 'D008', name: 'Abha Cash Center', email: 'acc@abha.sa', phone: '+966-17-888-1111', city: 'Abha', kycStatus: 'verified', monthVolume: 13, monthGmv: 52000, createdAt: daysAgo(50), active: true, onboardingState: 'submitted', ...generateRetailerOnboardingData('R022', 'submitted') },
  { id: 'R023', distributorId: 'D008', name: 'Southern Express Finance', email: 'sef@abha.sa', phone: '+966-17-888-2222', city: 'Abha', kycStatus: 'pending', monthVolume: 0, monthGmv: 0, createdAt: daysAgo(40), active: true, onboardingState: 'pending', ...generateRetailerOnboardingData('R023', 'pending') },
  { id: 'R024', distributorId: 'D008', name: 'Mountain Cash Point', email: 'mcp@abha.sa', phone: '+966-17-888-3333', city: 'Abha', kycStatus: 'pending', monthVolume: 10, monthGmv: 40000, createdAt: daysAgo(30), active: true, onboardingState: 'pending', ...generateRetailerOnboardingData('R024', 'pending') },
];
